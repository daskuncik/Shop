...
{
    public class DeleteOrderEventHandler : EventHandler<DeleteOrderEvent>
    {
        private ILogger<DeleteOrderEventHandler> logger;

        public DeleteOrderEventHandler(IEventBus eventBus,
            DbProxy proxy,
            ILogger<DeleteOrderEventHandler> logger)
             : base(eventBus, proxy)
        {
            this.logger = logger;
        }
        ...
        public async override Task Handle(DeleteOrderEvent @event)
        {
            try
            {
